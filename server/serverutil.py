...
def filestosend(self):
    ...
    print(h)
    serverdata = os.popen(
        "echo Jeffin | sudo -S ssh -i /home/jeffin/agrima/key/agrima_p2xlarge_200.pem ubuntu@52.43.166.212 ls /home/ubuntu/packages/yolov3/darknet/dataset/*.jpg").read()
    ...
    if(len(datalist) == 0):
        ...
        for k in l:
            ...
            m = "echo Jeffin | sudo scp -i /home/jeffin/agrima/key/agrima_p2xlarge_200.pem -r " + \
                url2.strip() + " " + server1
            os.system(m)
